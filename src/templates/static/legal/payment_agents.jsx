...
const PaymentAgents = () => (
    <div>
        ...
        <ol>
            ...
            <li>{it.L('The application shall be reviewed and assessed by the Company\'s Compliance and Marketing departments. It is noted that, following and implementing the anti-money laundering policy and conducting due diligence in accordance with the law and regulations, the Company\'s Compliance department shall request and collect all required information and documentation as per Section H. The Company reserves the right to change the requirements of transactions between the Agent’s account and clients.')}</li>
